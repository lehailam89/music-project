...
router.get("/create", auth_middleware_1.requireAuth, controller.create);
router.post("/create", auth_middleware_1.requireAuth, upload.single("avatar"), uploadCloud.uploadSingle, controller.createPost);
